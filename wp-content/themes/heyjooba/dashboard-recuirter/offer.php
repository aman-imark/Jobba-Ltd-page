...
<section class="dashboard-section">
    <div class="dashboard-main-content">
        ...
        <div class="action-dropdown dropdown">
            <button class="my-btn my-btn-3 dropdown-toggle ms-auto d-block" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="true">
                Action
            </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="" data-popper-placement="bottom-start">
                <li><button type="button" class="my-btn my-btn-3" onclick="share_offer_with_candidate(<?php echo $candidate_id; ?>,<?php echo $offer_id; ?>,<?php echo $recruiter_id; ?>)">Share With Candidate</button></li>
<!--
...
-->
                <li><a href="<?php echo get_the_permalink(64);?>?e_id=<?php echo $emp_id; ?>" class="my-btn my-btn-3">Message Employer</a></li>
            </ul>
        </div>
