<?php 
/*
Template Name:Recruiter Calender
*/
global $wpdb;
...
<section class="dashboard-section">
       ...
       <?php include(TEMPLATEPATH.'/dashboard-recuirter/rating-section.php'); ?>
            <div class="calender-sec-wrap bg-white-shadow">
                <div id="event-calendar"></div>

<!--
                <figure>
                    <input type="text" id="full_calender" value="open_cal" onclick="full_calender();">
                    <img src="<?php echo get_template_directory_uri();?>/dashboard-employer/images/calender.png" alt="calender">
                </figure>
-->
            </div>
        </div>
